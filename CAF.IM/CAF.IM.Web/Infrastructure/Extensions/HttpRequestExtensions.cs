...
namespace CAF.IM.Web.Infrastructure
{
    public static class HttpRequestExtensions 
    {
        ...
        /// </returns>
        public static HttpResponseMessage CreateChatSuccessMessage<T>(this HttpRequestMessage request, HttpStatusCode statusCode, T data, string filenamePrefix)
        {
        ...
        public static HttpResponseMessage CreateChatSuccessMessage<T>(this HttpRequestMessage Request, HttpStatusCode statusCode, T data)
        {
            var responseMessage = Request.CreateResponse(statusCode, data);
        ...
        /// <returns>HttpResponseMessage that wraps the given payload</returns>
        public static HttpResponseMessage CreateChatErrorMessage(this HttpRequestMessage request, HttpStatusCode statusCode, string message, string filenamePrefix)
        {
        ...
        /// <param name="data">Error response that is sent to the client.</param>
        /// <returns>HttpResponseMessage that wraps the given payload</returns>
        public static HttpResponseMessage CreateChatErrorMessage(this HttpRequestMessage request, HttpStatusCode statusCode, string message)
        {
            var responseMessage = request.CreateResponse(
                statusCode, 
                new ErrorModel { Message = message }, 
