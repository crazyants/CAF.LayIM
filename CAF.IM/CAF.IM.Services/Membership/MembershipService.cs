...
namespace CAF.IM.Services
{
    public class MembershipService : IMembershipService
    {
        ...
        public MembershipService(IRepository<ChatUser> repository, IRepository<ChatUserIdentity> chatUserIdentityRepository,
        ...
        private ChatUser AddUser(string userName, string providerName, string identity, string email)
        {
            ...
            {
                var usersWithNameLikeMine = _repository.Table.Count(u => u.Name.StartsWith(userName));
            ...
            _chatUserIdentityRepository.Insert(chatUserIdentity);
        ...
        {
            return _repository.Table.FirstOrDefault() == null;
        }
        ...
        {
            user = _repository.Table.FirstOrDefault(x=>x.Name==userName);
        ...
        {
            return _repository.Table.Any(u => u.Name.Equals(userName, StringComparison.OrdinalIgnoreCase));
        }
