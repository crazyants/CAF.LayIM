...
using CAF.IM.Core;
using CAF.IM.Core.UploadHandlers;
...
namespace CAF.IM.Services
{
    public class ChatService : IChatService
    {
        ...
        private readonly IRepository<ChatUserIdentity> _chatUserIdentityRepository;
        private readonly IRepository<Attachment> _attachmentRepository;
        private readonly IRepository<ChatClient> _chatClientRepository;
        ...
        public ChatService(ICache cache, IRepository<ChatUser> repository,
                        IRepository<ChatUserIdentity> chatUserIdentityRepository,
                        IRepository<Attachment> attachmentRepository,
                        IRepository<ChatClient> chatClientRepository,
                        IRepository<ChatMessage> chatMessagerepository,
                        IRepository<ChatRoom> chatRoomRepository,
                        IRepository<Notification> notificationRepository,
                        IRepository<Settings> settingsRepository)
            : this(cache,
                   repository, chatUserIdentityRepository, attachmentRepository, chatClientRepository
                         ...
                         ApplicationSettings settings)
        {
            ...
            _chatUserIdentityRepository = chatUserIdentityRepository;
        ...
        public void JoinRoom(ChatUser user, ChatRoom room, string inviteCode)
        {
            ...
            var roomEntity = _chatRoomRepository.GetById(room.Key);
            // Add this user to the room
            roomEntity.Users.Add(user);
            _chatRoomRepository.Update(roomEntity);
        ...
        public ChatMessage AddMessage(string userId, string roomName, string content)
        {
            ...
            ChatRoom room =_chatRoomRepository.VerifyUserRoom(_repository,_cache, user, roomName);
        ...
        {
            ChatMessage message = _chatMessagerepository.GetById(id);
        ...
        public void KickUser(ChatUser callingUser, ChatUser targetUser, ChatRoom targetRoom)
        {
            ...
            if (!_repository.IsUserInRoom(_chatRoomRepository,_cache, targetUser, targetRoom))
            {
        ...
        public ChatClient AddClient(ChatUser user, string clientId, string userAgent)
        {
            ...
            ChatClient client = _chatClientRepository.GetById(clientId);
            if (client != null)
            {
                return client;
            }
            ...
            _chatClientRepository.Insert(client);
        ...
        public string DisconnectClient(string clientId)
        {
            ...
            if (user != null)
            {
                ...
                _chatClientRepository.Delete(client);
        ...
        public void AllowUser(ChatUser user, ChatUser targetUser, ChatRoom targetRoom)
        {
            ...
            targetRoom.AllowedUsers.Add(targetUser);
            targetUser.AllowedRooms.Add(targetRoom);
            _chatRoomRepository.Update(targetRoom);
        ...
        public static void ValidateNote(string note, string noteTypeName = "note", int? maxLength = null)
        {
        ...
        public static void ValidateWelcome(string message)
        {
        ...
        public static string GetUserRoomPresence(ChatUser user, ChatRoom room)
        {
